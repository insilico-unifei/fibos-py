...
GitHub: https://github.com/insilico-unifei/fibos-R.git.
...
3.  **`fibos_config()`**: ONLY IN R: sets up the environment for some Python packages used by fibos in R. This function must be run before using any other functionality.
